              ...
              !isLogin && (
                 <div > 
                   ...
                   uppercase tracking-widest mb-2'>
                    ...
                    w-full pl-2 py-2 border-b border-zinc-200 focus:outline-none focus:border-zinc-950
                 ...
                 <div > 
                  ...
                  Password
                   ...
                   <div className='relative '>
                      <input type={showPassword ? "text" : "password"} value={password} onChange={(e)=> setPassword(e.target.value)} required className='
                      w-full pl-2 py-2 border-b border-zinc-200 focus:outline-none focus:border-zinc-950
                      text-sm text-zinc-900 bg-transparent placeholder:-zinc-300 pr-8 '
                       placeholder='******' />
