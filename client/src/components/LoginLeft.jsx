...
const LoginLeft = () => {
  return (
    <div
      className="hidden lg:flex lg:w-2/5 bg-[url('/bg-img.png')] bg-cover bg-center bg-no-repeat flex-col justify-between p-12 shrink-0 select-none"
    >
      <div>
      ...
      <div>
        ...
        <p className="text-zinc-300">
          ...
          in real-time. Create with clean JSX, verified layouts, and instant
          code export.
        </p>
